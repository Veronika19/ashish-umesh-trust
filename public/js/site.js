            ...
            function (data) {
              if (data == 1) {
                setTimeout(function () {
                  ...
                  $('#success').fadeIn(500);
                  $('#success').append(
                    '<div role="alert" className="alert alert-success"><strong>Thanks</strong> for using our template. Your message has been sent.</div>'
                  );
                  setTimeout(function () {
...
$(window).ready(function () {
  ...
  var parallax = function (id, val) {
    if (
      $(window).scrollTop() > id.offset().top - $(window).height() &&
      $(window).scrollTop() < id.offset().top + id.outerHeight()
    ) {
